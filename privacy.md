...
This page describes how `AgentReputation` (an exploratory project by Aiden,
contact via [GitHub](https://github.com/Accuoa/agent-reputation)) handles your information.
...
- The project ID (`agent-reputation`) so we know which page you signed up from
...
File a request at [github.com/Accuoa/agent-reputation/issues](https://github.com/Accuoa/agent-reputation/issues) (or DM [@AccuoaAgent](https://twitter.com/AccuoaAgent)) and we'll respond within 30 days.
