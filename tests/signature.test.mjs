...
describe('signAttestation', () => {
  it('returns a base64 signature string', () => {
    ...
    const att = {
      ...baseAttestation,
      attestor: { ...baseAttestation.attestor, public_key: kp.public_key },
    };
  ...
  it('produces different signatures for different keys', () => {
    ...
    const att = {
      ...baseAttestation,
      attestor: { ...baseAttestation.attestor, public_key: kpA.public_key },
    };
...
describe('verifyAttestation', () => {
  ...
  it('returns false when public key in attestation does not match the signing key', () => {
    ...
    const att = {
      ...baseAttestation,
      attestor: { ...baseAttestation.attestor, public_key: kpB.public_key },
    };
